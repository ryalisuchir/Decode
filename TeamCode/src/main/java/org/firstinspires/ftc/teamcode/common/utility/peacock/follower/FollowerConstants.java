...
public class FollowerConstants {
    ...
    public PeacockBrakingCoefficients predictiveBrakingCoefficients = new PeacockBrakingCoefficients(
            0.15,
            0.1,
            0.001);
    ...
    public FollowerConstants predictiveBrakingCoefficients(PeacockBrakingCoefficients predictiveBrakingCoefficients) {
