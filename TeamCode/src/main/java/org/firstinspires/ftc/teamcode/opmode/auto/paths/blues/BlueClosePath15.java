...
//        intakeMidHoldPos = m(new Pose(42, 53));
//        intakeMidPos = m(new Pose(16, 58.069, Math.toRadians(180)));
//        shootHoldPos = m(new Pose(44.70592363112392, 66.82712968299712));
//        slamGateHoldPos = m(new Pose(30, 54, Math.toRadians(180)));
//        slamGatePos = m(new Pose(12, 57.5, Math.toRadians(147)));
//        gateIntakeWraparoundHoldPos = m(new Pose(14.5, 45));
//        gateIntakeWraparoundPos = m(new Pose(14.5, 53, Math.toRadians(105)));
...
//                                intakeMidPos
//                        )
//                ).setLinearHeadingInterpolation(shootRegularPos.getHeading(), intakeMidPos.getHeading())
//                .addPath(
//                        new BezierCurve(
//                                intakeMidPos,
//                                shootHoldPos,
...
//                                shootRegularPos
//                        )
//                ).setLinearHeadingInterpolation(slamGatePos.getHeading(), shootRegularPos.getHeading())
//                .build();
//    }
//
