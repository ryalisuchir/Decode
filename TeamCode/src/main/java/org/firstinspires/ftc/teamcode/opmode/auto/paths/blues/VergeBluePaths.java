...
//    private int index;
//
//    public VergeBluePaths(Robot r) {
//        this.f = r.dt.getFollower();
//        startPos = m(Globals.RED_FAR_START);
//        shoot0Pos = m(new Pose(91.1757925072046, 20, Math.toRadians(0)));
...
//        shoot2Pos = m(new Pose(91.1757925072046, 20, Math.toRadians(0)));
//        intakeHpAgain1 = m(new Pose(134.62536023054756, 8, Math.toRadians(-10)));
//        intakeHpAgain2 = m(new Pose(123.18731988472625, 7, Math.toRadians(-10)));
//        intakeHpAgain3 = m(new Pose(134.45533141210376, 8, Math.toRadians(0)));
//        shoot3Pos = m(new Pose(91.1757925072046, 20, Math.toRadians(0)));
//        intakeHpAgainAgain1 = m(new Pose(134.62536023054756, 8, Math.toRadians(-10)));
//        intakeHpAgainAgain2 = m(new Pose(123.18731988472625, 7, Math.toRadians(-10)));
//        intakeHpAgainAgain3 = m(new Pose(134.45533141210376, 8, Math.toRadians(-0)));
//        shoot4Pos = m(new Pose(91.1757925072046, 20, Math.toRadians(0)));
//        parkPos = m(new Pose(110, 10, Math.toRadians(0)));
//
//        index = 0;
//    }
//
