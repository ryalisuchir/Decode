...
public class Red extends CommandOpMode {
    ...
    private boolean useSetShooterLoop = false;
    ...
    public void initialize() {
        r = new Halo(hardwareMap, Globals.Positions.RED_CUBE_START, Globals.Alliance.RED, Globals.Match.TELEOP);
    ...
    public void run() {
        ...
        if ((telemetryDivider++ & 0x3) == 0) {
            ...
            telemetry.addData("Loop Mode", useSetShooterLoop ? "SET SHOOTER" : "NORMAL");
        ...
        if (gamepad2.dpad_down) {
            r.turret.incrementOffset(false);
        }
        ...
        if (gamepad2.squareWasPressed()) {
            ...
            if (velocityLockEnabled) {
                ...
                r.shooter.clearVelocityFloor();
            }
        }

        if (gamepad2.circleWasPressed()) {
            useSetShooterLoop = !useSetShooterLoop;
        }
