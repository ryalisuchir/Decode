...
public class BlueClosePath21 {
    ...
    public BlueClosePath21(Halo r) {
        ...
        shootAudPos = alliancePose(new Pose(88, 77, Math.toRadians(13)));
    ...
    public PathChain intakeCloseAndShoot() {
        return f.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(intakeObeliskPos.getHeading(), shootObeliskPos.getHeading())
                //.setReversed()
                .build();
    }
    ...
    public PathChain next() {
        switch (index++) {
            ...
            case 8: return intakeFarSequence();
            case 9: return intakeCloseAndShoot();
            default: return null;
        }
    }
