...
public class RedClosePath9 {
    private final Follower f;

    public Pose startPos, shootRegularPos, intakeMidInitialPos, intakeMidHoldPos, intakeMidPos, shootHoldPos, intakeFarPos, parkPos, lastShootPos;
    private int index;

    public RedClosePath9(Robot r) {
