...
@Autonomous
public class VRed extends OpMode {
    Robot r;
    VergeRedPaths p;
    boolean read = false;
    ...
    public void init() {
        ...
        r.shooter.setCustomDistance(p.shoot0Pos.getX()-11, p.shoot0Pos.getY()-11);
        CommandScheduler.getInstance().schedule(new FarInitCmd(r, Globals.Side.RED));
        telemetry = new MultipleTelemetry(telemetry, FtcDashboard.getInstance().getTelemetry());
    }

    public void init_loop() {
        telemetry.addLine("Created all subsystems.");
        telemetry.addData("Initialized:", "Verge Allianced Auto (Red)");
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        new ParallelCommandGroup(
                                ...
                                new InstantCommand(() -> Globals.turretState = Globals.TurretState.RED_FAR_GOAL),
                                new SequentialCommandGroup(
