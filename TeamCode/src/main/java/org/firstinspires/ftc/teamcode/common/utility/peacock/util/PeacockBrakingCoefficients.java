package org.firstinspires.ftc.teamcode.common.utility.peacock.util;

/**
 * @see PeacockBrakingCoefficients
 * @author Jacob Ophoven - 18535, Frozen Code
 * @version 12/24/2025
 */
public class PeacockBrakingCoefficients {
     ...
     */
    public PeacockBrakingCoefficients(double proportional, double linearBraking, double quadraticFriction) {
     ...
     */
    public PeacockBrakingCoefficients withMaximumBrakingPower(double maximumBrakingPower) {
