...
public final class TurretMath {
    ...
    public static double[] getCornerGoalCenter(CornerGoal goal, double robotY) {
        ...
        double yBias;
        if (blueGoal) {
            xBias = closeZone ? Globals.GOAL_CENTER_X_BIAS_CLOSE_BLUE : Globals.GOAL_CENTER_X_BIAS_FAR_BLUE;
            yBias = closeZone ? Globals.GOAL_CENTER_Y_BIAS_CLOSE_BLUE : Globals.GOAL_CENTER_Y_BIAS_FAR_BLUE;
        } else {
            xBias = closeZone ? Globals.GOAL_CENTER_X_BIAS_CLOSE_RED : Globals.GOAL_CENTER_X_BIAS_FAR_RED;
            yBias = closeZone ? Globals.GOAL_CENTER_Y_BIAS_CLOSE_RED : Globals.GOAL_CENTER_Y_BIAS_FAR_RED;
        }
