...
//import org.firstinspires.ftc.teamcode.opmode.auto.paths.red.close.RedPush21Pathing;
//
//import java.util.Collections;
//
//@Autonomous
//public class Red21Push extends OpMode {
//    Halo r;
//    RedPush21Pathing p;
//
//    @Override
...
//        telemetry.addData("Initialized:", "21 Ball Auto (Red). Pushes alliance.");
//        r.initLoop(r);
...
//                        new ParallelCommandGroup(
//                                new SequentialCommandGroup(
//                                        new DeferredCommand(() -> new ResetShooterCmd(r, 3, r.turret.redPushFirstSpike()), Collections.emptyList()),
//                                        r.turret.redPushFirstSpike()),
//                                r.spinner.intake(),
//                                new FollowPathCmd(r, p.next())
//                        ),
//                        new RapidOrderCmd(r),
