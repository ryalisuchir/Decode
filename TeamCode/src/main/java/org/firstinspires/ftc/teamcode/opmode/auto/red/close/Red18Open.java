...
import org.firstinspires.ftc.teamcode.opmode.auto.paths.red.close.Red18OpenPathing;

import java.util.Collections;

@Autonomous
public class Red18Open extends OpMode {
    Halo r;
    Red18OpenPathing p;
    ...
    public void start() {
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new ParallelCommandGroup(
                                new SequentialCommandGroup(
                                        new DeferredCommand(() -> new ResetShooterCmd(r, 4, r.turret.followObeliskCmd()), Collections.emptyList()),
                                ...
                                new SequentialCommandGroup(
                                        ...
                                        new WaitCommand(1800),  // wait longer than transfer's 300ms ejection + pivot up settling
