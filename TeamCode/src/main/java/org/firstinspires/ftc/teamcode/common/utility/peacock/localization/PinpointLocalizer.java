package org.firstinspires.ftc.teamcode.common.utility.peacock.localization;
...
import org.firstinspires.ftc.teamcode.common.utility.peacock.util.PoseConverter;
...
public class PinpointLocalizer implements Localizer {
    ...
    public void setPose(Pose setPose) {
        odo.setPosition(PoseConverter.poseToPose2D(setPose, PeacockCoordinates.INSTANCE));
    ...
    public void update() {
        odo.update();
        Pose currentPinpointPose = PoseConverter.pose2DToPose(odo.getPosition(), PeacockCoordinates.INSTANCE);
