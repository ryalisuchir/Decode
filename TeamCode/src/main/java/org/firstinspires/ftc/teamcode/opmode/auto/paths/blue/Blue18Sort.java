...
import org.firstinspires.ftc.teamcode.common.commandbase.commands.RapidSpikeCmd;
...
import org.firstinspires.ftc.teamcode.opmode.auto.paths.red.close.Red18SortedPathing;

import java.util.Collections;

@Autonomous
public class Blue18Sort extends OpMode {
    Halo r;
    Red18SortedPathing p;

    @Override
    public void init() {
        CommandScheduler.getInstance().reset();
        r = new Halo(hardwareMap, Globals.Positions.BLUE_EXODUS_START, Globals.Alliance.BLUE, Globals.Match.AUTO);
        p = new Red18SortedPathing(r);
    ...
    public void init_loop() {
        ...
        telemetry.addData("Initialized:", "18 Ball Auto (Blue). Sorted.");
        r.initLoop(r);
