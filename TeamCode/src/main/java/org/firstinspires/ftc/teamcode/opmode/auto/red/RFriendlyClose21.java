...
import org.firstinspires.ftc.teamcode.opmode.auto.paths.reds.FriendlyRedClosePath21;
import org.firstinspires.ftc.teamcode.opmode.auto.paths.reds.RedClosePath21;

@Autonomous
public class RFriendlyClose21 extends OpMode {
    Halo r;
    FriendlyRedClosePath21 p;
    ...
    public void init() {
        ...
        r.init();
        p = new FriendlyRedClosePath21(r);
    ...
    public void init_loop() {
        ...
        telemetry.addData("Initialized:", "21 Ball Friendly Auto (Red)");
    ...
    public void start() {
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new RapidOrderCmd(r), //kicks middle spike
                        new ParallelCommandGroup(
                                new FollowPathCmd(r, p.next()), //intakes spike closest to obelisk
                                new ResetShooterCmd(r, 2.5)
                        ),
                        new RapidOrderCmd(r),
